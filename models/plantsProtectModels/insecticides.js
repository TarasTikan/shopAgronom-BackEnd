...
const insecticidesSchema = new Schema(
  {
...
insecticidesSchema.post("save", handleMongooseError);

const Insecticides = model("insecticide", insecticidesSchema);

module.exports = Insecticides;
